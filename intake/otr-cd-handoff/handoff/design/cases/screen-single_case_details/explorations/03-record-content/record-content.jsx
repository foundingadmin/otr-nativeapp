    ...
    <div className="rc-firm">
      <div className="rc-firm-head">
        ...
        <div className="rc-firm-id">
          ...
          <div className="rc-firm-sub">Glendale, CA</div>
  ...
  return (
    <div className="rc-mod">
      ...
      <div className="rc-ppl"><div className="rc-ppl-av"><FI name="user-square-single" size={18} color="var(--wf-muted)" /></div>
        <div className="rc-ppl-main"><div className="rc-ppl-n">You</div><div className="rc-ppl-r">Account Owner</div></div></div>
      <div className="rc-ppl"><div className="rc-ppl-av"><FI name="user-square-single" size={18} color="var(--wf-muted)" /></div>
        <div className="rc-ppl-main"><div className="rc-ppl-n">Marcus Vale</div><div className="rc-ppl-r">Case Defendant</div></div></div>
      <div className="rc-ppl-add"><FI name="add-circle" size={15} color="var(--otr-blue)" />Add a participant</div>
    </div>
  );
}

// manage variation: each removable participant carries a clear Remove action;
// the account owner can't remove themselves, so shows a tag instead.
function ParticipantsManage(){
  return (
    <div className="rc-mod">
      <div className="rc-mod-h"><FI name="multiple-users-1" size={15} color="var(--wf-muted)" />Participants<span className="rc-mod-tag">Manage</span></div>
      <div className="rc-ppl"><div className="rc-ppl-av"><FI name="user-square-single" size={18} color="var(--wf-muted)" /></div>
        <div className="rc-ppl-main"><div className="rc-ppl-n">You</div><div className="rc-ppl-r">Account Owner</div></div>
        <span className="rc-ppl-tag">This is you</span></div>
      <div className="rc-ppl"><div className="rc-ppl-av"><FI name="user-square-single" size={18} color="var(--wf-muted)" /></div>
        <div className="rc-ppl-main"><div className="rc-ppl-n">Marcus Vale</div><div className="rc-ppl-r">Case Defendant</div></div>
        <button className="rc-ppl-remove"><FI name="delete-circle" size={12} color="var(--money)" />Remove</button></div>
      <div className="rc-ppl"><div className="rc-ppl-av"><FI name="user-square-single" size={18} color="var(--wf-muted)" /></div>
        <div className="rc-ppl-main"><div className="rc-ppl-n">Dana Vale</div><div className="rc-ppl-r">Added by you</div></div>
        <button className="rc-ppl-remove"><FI name="delete-circle" size={12} color="var(--money)" />Remove</button></div>
      <div className="rc-ppl-add"><FI name="add-circle" size={15} color="var(--otr-blue)" />Add a participant</div>
    </div>
  );
  ...
  return (
    <>
      ...
      <DCSection id="rc-participants" title="Participants module"
        subtitle="Net-new, first time in review. Shows case participants: the booker plus any added defendant or others. A view variant and a manage variant with clear remove actions. The add-participant affordance is shown but the permission rule is pending Alex's confirmation (F-3), so who can add or remove is not yet wired.">
        <DCArtboard id="rc-participants-card" label="Participants · view" width={356} height={300}>
          <div className="otr" style={{ background:'var(--wf-bg)', height:'100%', padding:16, boxSizing:'border-box' }}>
            <Participants />
            <Cap>Add a participant is placed but gated pending the F-3 permission rule.</Cap>
          </div>
        </DCArtboard>
        <DCArtboard id="rc-participants-manage" label="Participants · manage & remove" width={356} height={404}>
          <div className="otr" style={{ background:'var(--wf-bg)', height:'100%', padding:16, boxSizing:'border-box' }}>
            <ParticipantsManage />
            <Cap>Each removable participant carries a clear Remove action; the account owner can't remove themselves. Both add and remove are gated pending F-3.</Cap>
          </div>
        </DCArtboard>
      </DCSection>
    </>
...
if (typeof document !== 'undefined' && !document.getElementById('record-content-css')) {
  ...
  .rc-firm-reviews{ font-size:11.5px; color:var(--wf-muted); font-weight:600;
  ...
  .rc-mod-h + .rc-txn{ border-top:none; }
  ...
  .rc-mod-h + .rc-ppl{ border-top:none; }
  .rc-ppl-tag{ flex:none; font-size:10.5px; font-weight:700; color:var(--wf-faint);
    background:var(--wf-fill); border-radius:999px; padding:3px 9px; }
  .rc-ppl-remove{ flex:none; display:inline-flex; align-items:center; gap:5px; font-family:inherit;
    font-size:11.5px; font-weight:800; color:var(--money); background:#fff; border:1px solid var(--money-line);
