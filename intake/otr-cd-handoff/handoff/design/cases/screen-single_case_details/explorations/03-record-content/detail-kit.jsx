...
/* __IIFE__ */;(function () {
  ...
  function TicketHero({ rec }) {
    ...
    return (
      ...
      <div className="scrim" />
      <a className="explore-pin" href="explorations/01-details-exploration/01-details-exploration.html"><FI name="triangle-arrow-expand-window-1" size={10} color="#fff" />Ticket display exploration</a>
      <div className="ttop">
