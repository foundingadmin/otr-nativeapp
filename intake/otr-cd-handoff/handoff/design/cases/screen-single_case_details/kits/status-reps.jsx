...
function CaseStatusReps(){
  return (
      <DCSection id="case-anatomy" title="Single Case Details" eyebrow="Screen" updated="Updated • Fri Jul 10, 2026"
        subtitle="The case detail screen, Active baseline. The badge carries the lifecycle, the action item carries the lift, and the record sits behind the Overview, Documents, and Payments tabs. The standalone timeline is parked (DR-CD-003); lifecycle now lives in the case chat.">
        <DCArtboard id="pattern-active" label="Active" width={390} height={1188}>
          <FullDetail rec={REPS.find(r=>r.key==='active').rec} height={1188} />
        </DCArtboard>
      </DCSection>
  );
}

window.CaseStatusReps = CaseStatusReps;
